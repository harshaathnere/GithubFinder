class Github {
    ...
    async getUser(user) {
        ...
        const repoResponse = await fetch (`https://api.github.com/users/${user}repo?per_page=${this.repos_count}&sort=${this.repos_sort}&client_id= ${this.client_id}&client_secret_id = &${this.secret_id}`);
